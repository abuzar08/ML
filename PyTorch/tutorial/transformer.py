...
class SelfAttention(nn.Module):
    ...
    def __init__ (self, embed_size, heads):
        ...
        assert(self.head_dim*heads == self.embed_size), "Maintain divisibility between heads and embed size"
    ...
    def forward(self, values, keys, query, mask):
        ...
        # k shape: N, k_len, heads, heads_dim
        ...
        # Values: N, v_len, heads, heads_dim
        # out = N, q_len, heads, head_dim
...
class Transformer(nn.Module):
    ...
    trg_pad_index, embed_size = 256, num_layers = 6, forward_expansion = 4, 
    heads = 8, dropout = 0, device = "cuda", max_length = 100):
        super(Transformer, self).__init()
        self.encoder = Encoder(
            src_vocab_size, embed_size, num_layers,
            heads, device, forward_expansion, dropout, max_length
        )

        self.decoder = Decoder(
            trg_vocab_size, embed_size, num_layers, 
            heads, forward_expansion, dropout, device, max_length
        )
